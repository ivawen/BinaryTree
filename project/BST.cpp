...
using namespace std;
    ...
    void BST::AddNodePrivate(int value, node* pointer)
    {
       ...
       else if (value > pointer->value) // is the value we want add is greater then value in current node 
       {
    ...
    void BST::PrintInOrderPrivate(node* pointer)
    {
        ...
        if(root != NULL)
        {
            ...
            {
                //go left
                PrintInOrderPrivate(pointer->leftChild);                
            }
            ...
            {
                PrintInOrderPrivate(pointer-> rightChild);                
            }
        }
        //if tree empty
        else
